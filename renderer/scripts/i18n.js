...
const LOCALES = {
  ko: {
    ...
    'studio.engine.off': '엔진 꺼짐',
    'studio.engine.start': '엔진 시작',
    'studio.device': '오디오 장치',
    'studio.device.none': '엔진 시작 후 표시',
    'studio.song': '반주 (스템)',
  ...
  en: {
    ...
    'studio.engine.off': 'Engine off',
    'studio.engine.start': 'Start engine',
    'studio.device': 'Audio device',
    'studio.device.none': 'Shown after engine starts',
    ...
    'studio.fx.save': 'Save FX',
    'studio.fx.load': 'Reload',
