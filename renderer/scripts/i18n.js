...
const LOCALES = {
  ko: {
    ...
    'studio.song': '반주 (스템)',
    'studio.loadSong': '라이브러리 선택 곡 불러오기',
    ...
    'set.vst.title':'VST3 플러그인',
    'set.vst.desc':'스튜디오 입력 이펙트로 쓸 VST3를 스캔합니다',
    'set.vst.scan':'스캔',
  ...
  en: {
    ...
    'studio.loadSong': 'Load selected library song',
    ...
    'set.vst.title':'VST3 plugins',
    'set.vst.desc':'Scan VST3 plugins to use as studio input effects',
    'set.vst.scan':'Scan',
