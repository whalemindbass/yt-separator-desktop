...
contextBridge.exposeInMainWorld('yssApi', {
  ...
  settings: {
    ...
    vstDirs:          ()          => ipcRenderer.invoke('settings:vstDirs'),
    vstDirsAdd:       ()          => ipcRenderer.invoke('settings:vstDirsAdd'),
    vstDirsRemove:    (dir)       => ipcRenderer.invoke('settings:vstDirsRemove', dir),
  ...
  dialog: {
    ...
    pickLutFile:    ()           => ipcRenderer.invoke('dialog:pickLutFile'),
  ...
  engine: {
    ...
    recordArm:   (projectKey, trackIds, who, midiIds) => ipcRenderer.invoke('engine:recordArm', projectKey, trackIds, who, midiIds),
    noteOn:      (track, pitch, vel) => ipcRenderer.invoke('engine:cmd', { cmd: 'noteOn', track, pitch, vel }),
    noteOff:     (track, pitch)      => ipcRenderer.invoke('engine:cmd', { cmd: 'noteOff', track, pitch }),
    midiClip:    (clip)   => ipcRenderer.invoke('engine:cmd', { cmd: 'midiClip', ...clip }),
    midiClipRemove: (id)  => ipcRenderer.invoke('engine:cmd', { cmd: 'midiClipRemove', id }),
    midiClear:   ()       => ipcRenderer.invoke('engine:cmd', { cmd: 'midiClear' }),
    ...
    recTrackSetInput: (id, cfg) => ipcRenderer.invoke('engine:cmd', { cmd: 'recTrackSetInput', id, ...(cfg || {}) }),
